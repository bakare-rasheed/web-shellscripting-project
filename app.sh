#!/bin/bash
# Move the application zip file to the same directory as the script
mv /home/bakare/Downloads/2129_crispy_kitchen.zip ./2129_crispy_kitchen.zip
...
sudo docker build -t bakare-app0 .

sudo docker run -d -p 80:80 bakare-app0
